...
<head>
	...
	<link rel="shortcut icon" href="{{ URL::asset('faviconerin.png') }}" type="image/x-icon" />
	<link rel="icon" href="{{ URL::asset('faviconerin.png') }}" type="image/x-icon" />

...
<header id="cr-navbar" class="navbar cr-navbar">
	<div class="container">
		...
		<a class="navbar-brand col-lg-2 col-sm-1 col-xs-12" href="{{ URL::to('/') }}" style="background: #FFFFFF !important">
			<span>
				<img src="{{ URL::asset('img/logoerin.png') }}" alt="{{ Config::get('local.site.name') }}" class="visible-md visible-lg" />
				<img src="{{ URL::asset('img/logoerin-small.png') }}" alt="{{ Config::get('local.site.name') }}" class="visible-xs visible-sm" />
			</span>
		</a>
...
@else
	...
	@endif
	@if( Route::currentRouteName() !== 'landing' && Route::currentRouteName() !== 'inicio' )

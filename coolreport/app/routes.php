...
Route::post( 'report/table', array('as' => 'report.table', 'uses' => 'ReportController@table1') );
...
Route::get( 'heatMap', array('as' => 'ihealth.getHeatMap', 'uses' => 'DashboardHealthController@getHeatMap') );
...
Route::get( 'clientInfo', array('as' => 'ihealth.getClientInfo', 'uses' => 'DashboardHealthController@getClientInfo') );
...
Route::get( '/', array('as' => ('inicio'), 'uses' => function () {
	if(Auth::check())
    	return Redirect::to('health');
    else
    	return View::make('dashitems.inicio');
} ) );
//despues del as es lo que hay que poner para la llamada desde el html, despues del route get es como vamos a llamaar a la url a lq ue queremos ir
Route::get( '/landing', array('as' => ('landing'), 'uses' => function () {
	if(Auth::check())
    	return Redirect::to('health');
    else
